...
# the_so_so_blog/
APPS_DIR = ROOT_DIR / "the_so_so_blog"
env = environ.Env()
...
LOCAL_APPS = [
    "the_so_so_blog.users",
    "the_so_so_blog.blog_posts",
    "the_so_so_blog.authentication",
]
...
MIGRATION_MODULES = {"sites": "the_so_so_blog.contrib.sites.migrations"}
...
STATICFILES_DIRS = [str(ROOT_DIR / "front_end_statics")]
...
ADMINS = [("""Nguyen Tuan Anh""", "anhnt20101995@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "the_so_so_blog.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "the_so_so_blog.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "the_so_so_blog.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "the_so_so_blog.users.forms.UserSocialSignupForm"}
